...
The most important thing to do now is create a README.md file and save it in the top level directory of your package. 

From here, you will want to keep working on your package until you feel it is ready to put on CRAN. When you are ready for this check out Hadley Wickham's R Packages book as that is beyond the scope of this tutorial. Happy R package building!
